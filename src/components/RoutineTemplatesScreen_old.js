...
const RoutineTemplatesScreen = ({ clients = [], onAssignRoutine, fetchTemplates, deleteTemplate, onGoBack }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 pt-4 px-6">
      <div className="max-w-6xl mx-auto px-4 py-8">
        {/* Header */}
        <div className="text-center mb-6">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mb-4">
            <h1 className="text-4xl font-bold text-gray-800 mb-3">Templates de Rutinas</h1>
            <p className="text-gray-600 text-lg">Crea y gestiona plantillas de rutinas para tus clientes</p>
          </div>
        </div>
